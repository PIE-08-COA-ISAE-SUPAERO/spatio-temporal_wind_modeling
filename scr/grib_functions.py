...
def main(hour_chosen,altitude_chosen,latitude_min,
         latitude_max, longitude_min,longitude_max, downloads_path, save_file_SP1, save_file_HP1):
    ...
    grib_to_nc(get_grib_from_path('HP1',hour_chosen,downloads_path) , save_file_HP1)
    grib_to_nc(get_grib_from_path('SP1',hour_chosen,downloads_path) , save_file_SP1)
